...
def get_prompt():
    return (
        "Context information is below.\n"
            ...
            "4. If the context is helpful or quite relevant, include HTML <a></a> tag format link at the end of response to the first source document based on metadata {file_url} "
